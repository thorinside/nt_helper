...
void main() {
  ...
  group('AlgorithmNodeWidget Collapse Toggle Tests', () {
    ...
    testWidgets('toggle not shown when <= 5 unconnected ports', (tester) async {
    ...
    testWidgets(
      'tapping toggle hides unconnected ports and shows hidden count',
      (tester) async {
