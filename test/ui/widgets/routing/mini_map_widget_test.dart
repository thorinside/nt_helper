...
void main() {
  group('MiniMapWidget', () {
    ...
    group('Initialization', () {
      testWidgets('should create widget with default dimensions', (tester) async {
        ...
        final miniMapWidget = tester.widget<MiniMapWidget>(find.byType(MiniMapWidget));
      ...
      testWidgets('should properly receive and store canvas dimensions', (tester) async {
    ...
    group('Scroll Controller Binding', () {
      testWidgets('should accept horizontal scroll controller', (tester) async {
        ...
        final miniMapWidget = tester.widget<MiniMapWidget>(find.byType(MiniMapWidget));
        expect(miniMapWidget.horizontalScrollController, equals(horizontalController));
      });
      ...
      testWidgets('should accept vertical scroll controller', (tester) async {
        ...
        final miniMapWidget = tester.widget<MiniMapWidget>(find.byType(MiniMapWidget));
        expect(miniMapWidget.verticalScrollController, equals(verticalController));
      });

      testWidgets('should add listeners to scroll controllers on initialization', (tester) async {
    ...
    group('Viewport Position Tracking', () {
      testWidgets('should update viewport position when scroll controllers change', (tester) async {
        await tester.pumpWidget(
          MaterialApp(
      ...
      testWidgets('should handle scroll controller disposal gracefully', (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: MiniMapWidget(
    ...
    group('Widget Lifecycle Management', () {
      testWidgets('should properly dispose of listeners when widget is disposed', (tester) async {
    ...
    group('MiniMapPainter', () {
      group('Coordinate Scaling Calculations', () {
        test('should correctly scale canvas coordinates to mini-map coordinates', () {
          ...
          final testCases = [
            ...
            (canvasCoord: const Offset(1000, 1000), expected: const Offset(30, 30)),
            (canvasCoord: const Offset(2500, 3000), expected: const Offset(75, 90)),
            (canvasCoord: const Offset(5000, 5000), expected: const Offset(150, 150)),
          ];
        ...
        test('should handle edge cases for coordinate scaling', () {
          ...
          final scaledNegative = Offset(negativeCoord.dx * scaleFactor, negativeCoord.dy * scaleFactor);
          ...
          final scaledZero = Offset(zeroCoord.dx * scaleFactor, zeroCoord.dy * scaleFactor);
          
          expect(scaledZero, equals(Offset.zero));
          
          // Test very large coordinates
          const largeCoord = Offset(10000, 8000);
          final scaledLarge = Offset(largeCoord.dx * scaleFactor, largeCoord.dy * scaleFactor);
      ...
      group('Node Position Scaling', () {
        test('should correctly scale node positions from canvas to mini-map space', () {
          ...
          for (final entry in nodePositions.entries) {
            ...
            expect(scaled.dx, closeTo(expected.dx, 0.1), 
                reason: 'Node ${entry.key} X coordinate scaling failed');
            expect(scaled.dy, closeTo(expected.dy, 0.1), 
      ...
      group('Clipping and Bounds', () {
        test('should correctly calculate clipping bounds for overflow prevention', () {
          const miniMapWidth = 200.0;
          const miniMapHeight = 150.0;
          ...
          for (int i = 0; i < testRectangles.length; i++) {
            ...
            final maxWidth = (miniMapWidth - clippedLeft).clamp(0.0, miniMapWidth);
            final maxHeight = (miniMapHeight - clippedTop).clamp(0.0, miniMapHeight);
    ...
    group('Tap-to-Navigate Interaction', () {
      group('Coordinate Transformation', () {
        testWidgets('should convert mini-map tap coordinates to canvas coordinates', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          final testCases = [
            ...
            (miniMapTap: const Offset(0, 0), expectedCanvas: const Offset(0, 0)),
            // Tap at center of mini-map
            (miniMapTap: const Offset(100, 75), expectedCanvas: const Offset(3333.33, 2500)),
            // Tap at bottom-right of mini-map
            (miniMapTap: const Offset(150, 150), expectedCanvas: const Offset(5000, 5000)),
            // Tap at quarter position
            (miniMapTap: const Offset(50, 37.5), expectedCanvas: const Offset(1666.67, 1250)),
          ];
        ...
        testWidgets('should handle edge cases for coordinate transformation', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: Scaffold(
                body: MiniMapWidget(
          ...
          final edgeCases = [
            ...
            (miniMapTap: const Offset(300, 300), expectedCanvas: const Offset(10000, 10000)),
            // Negative coordinates (outside mini-map)
            (miniMapTap: const Offset(-50, -50), expectedCanvas: const Offset(-1666.67, -1666.67)),
          ];
      ...
      group('Tap Detection and Response', () {
        testWidgets('should detect tap on mini-map widget', (tester) async {
          ...
          await tester.tapAt(const Offset(120, 95)); // Position relative to screen (accounting for widget position)
          await tester.pump();
        ...
        testWidgets('should respond to tap within 50ms requirement', (tester) async {
      ...
      group('Scroll Navigation', () {
        testWidgets('should animate scroll controllers to target position', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          await tester.tapAt(const Offset(120, 95)); // Position relative to screen
        ...
        testWidgets('should apply boundary checking for scroll positions', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          for (final tapPosition in testCases) {
            await tester.tapAt(tapPosition.translate(20, 20)); // Account for widget position
            await tester.pumpAndSettle();

            // Verify scroll positions are within valid bounds
            expect(horizontalController.offset, 
                   inInclusiveRange(horizontalController.position.minScrollExtent, 
                                 horizontalController.position.maxScrollExtent));
            expect(verticalController.offset,
                   inInclusiveRange(verticalController.position.minScrollExtent,
    ...
    group('Viewport Rectangle Dragging', () {
      group('Drag Gesture Handling', () {
        testWidgets('should detect pan start gesture on viewport rectangle', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          const dragStartPosition = Offset(40, 35); // Should be within viewport rectangle
          
          // Use gesture to trigger pan start by moving slightly
          final gesture = await tester.startGesture(dragStartPosition.translate(20, 20));
          await gesture.moveBy(const Offset(1, 1)); // Small movement to trigger pan
          await tester.pump();
        ...
        testWidgets('should track drag state during pan gesture', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
        ...
        testWidgets('should calculate correct viewport movement deltas during drag', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          const dragDelta = Offset(20, 15); // Move right and down in mini-map space
      ...
      group('Real-time Position Updates', () {
        testWidgets('should update scroll positions continuously during drag', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          final gesture = await tester.startGesture(dragStart.translate(20, 20));
          await tester.pump();
          ...
          for (final step in moveSteps) {
            ...
            expect(horizontalController.offset, isNot(equals(initialHorizontalOffset)));
            expect(verticalController.offset, isNot(equals(initialVerticalOffset)));
          }
          
          await gesture.up();
        });

        testWidgets('should maintain smooth updates during rapid drag movements', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          final state = tester.state<MiniMapWidgetState>(find.byType(MiniMapWidget));
          final expectedCanvasDeltaX = (dragEnd.dx - dragStart.dx) / state.scaleFactor;
          final expectedCanvasDeltaY = (dragEnd.dy - dragStart.dy) / state.scaleFactor;
          
          expect(horizontalController.offset, greaterThan(expectedCanvasDeltaX * 0.8));
          expect(verticalController.offset, greaterThan(expectedCanvasDeltaY * 0.8));
        });
      });

      group('Edge Clamping', () {
        testWidgets('should prevent dragging viewport beyond left canvas edge', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          expect(horizontalController.offset, 
                 greaterThanOrEqualTo(horizontalController.position.minScrollExtent));
          expect(verticalController.offset, 
                 greaterThanOrEqualTo(verticalController.position.minScrollExtent));
        });

        testWidgets('should prevent dragging viewport beyond right canvas edge', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          const largeDragRight = Offset(100, 100); // Try to drag far to the right
        ...
        testWidgets('should keep viewport within canvas bounds during drag', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
          ...
          final testCases = [
            ...
            (start: const Offset(100, 75), delta: const Offset(-200, -200)), // Far top-left
            (start: const Offset(100, 75), delta: const Offset(200, 200)),   // Far bottom-right
            (start: const Offset(50, 50), delta: const Offset(-100, 0)),     // Left edge
            (start: const Offset(150, 100), delta: const Offset(100, 0)),    // Right edge
          ];
      ...
      group('Visual Feedback', () {
        testWidgets('should show drag cursor during viewport rectangle drag', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
        ...
        testWidgets('should highlight viewport rectangle during drag', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
        ...
        testWidgets('should show pointer cursor on hover over viewport rectangle', (tester) async {
          ...
          const hoverPosition = Offset(40, 30); // Should be within viewport rectangle
      ...
      group('Performance Requirements', () {
        testWidgets('should maintain 60 FPS during drag operations', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
        ...
        testWidgets('should update viewport position within 16ms of drag event', (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: SingleChildScrollView(
                controller: horizontalController,
