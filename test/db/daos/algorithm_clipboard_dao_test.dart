...
void main() {
  ...
  FullPresetDetails clipboard(List<FullPresetSlot> slots) =>
      FullPresetDetails(
        preset: PresetEntry(
          id: -1,
          name: 'ignored-name',
  ...
  group('Algorithm clipboard DAO', () {
    ...
    test('saveClipboardTemplate pins reserved name/category and reindexes', () async {
      ...
      final id = await database.presetsDao.saveClipboardTemplate(clipboard([
        slot(7, 'ALG1', parameterValues: {1: 42}, mappings: {1: mapping}),
