...
void main() {
  ...
  group('V/Oct Parameter Disambiguation Tests', () {
    ...
    test('should find correct V/Oct INPUT parameter when connecting FROM physical input', () async {
      ...
      when(mockCubit.state).thenReturn(
        DistingState.synchronized(
          ...
          slots: [
            ...
            Slot(
              algorithm: Algorithm(algorithmIndex: 0, guid: 'lua ', name: 'Lua Script'),
              ...
              parameters: [
                ...
                ParameterInfo(
                  ...
                  min: 0,
                  max: 28,
                  defaultValue: 4, // Input 4 - this should be classified as INPUT
                  unit: 1,
                  powerOfTen: 0,
                ),
                ...
                ParameterInfo(
                  ...
                  min: 0,
                  max: 28,
                  defaultValue: 16, // Output 4 - this should be classified as OUTPUT
                  unit: 1,
                  powerOfTen: 0,
                ),
              ],
    ...
    test('should find correct V/Oct OUTPUT parameter when connecting TO external output', () async {
      // Same setup as above
      when(mockCubit.state).thenReturn(
        DistingState.synchronized(
          disting: MockIDistingMidiManager(),
    ...
    test('should validate connection from physical input to algorithm input port', () async {
          ...
          slots: [
            Slot(
              ...
              values: [
                ...
                ParameterValue(algorithmIndex: 0, parameterNumber: 31, value: 16),
              ],
              enums: [],
              mappings: [],
              valueStrings: [],
