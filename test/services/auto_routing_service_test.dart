...
void main() {
  ...
  group('AutoRoutingService', () {
    ...
    group('Output to Input Routing', () {
      test('should detect and use Output bus when source is already configured to use it', () async {
    ...
    group('Bus Sharing for Same Source', () {
      test('should REUSE same bus when connecting same source to multiple targets (VCO -> Reverb L/R)', () async {
        ...
        expect(result.sourceBus, equals(21), 
          reason: 'Same source feeding multiple targets should use the same bus');
      });
      
      test('should use different buses for different sources even to same target', () async {
    ...
    group('Bus Exclusivity', () {
      ...
      test('should reuse bus when connecting same source port to different targets', () async {
      ...
      test('should reuse bus only for duplicate connection (same source and target)', () async {
        // Existing connection
        final existingConnections = [
          const Connection(
            id: 'conn1',
    ...
    group('Bus Priority', () {
      ...
      test('should use output buses (13-20) when aux buses exhausted', () async {
        // Fill all aux buses
    ...
    group('Complex Scenarios', () {
      test('should handle adding, removing, and re-adding connections', () async {
        var existingConnections = <Connection>[];
    ...
    group('Error Handling', () {
      test('should throw InsufficientBusesException when all buses exhausted', () {
        // Fill all buses
        final existingConnections = <Connection>[];
        for (int i = 1; i <= 28; i++) {
          existingConnections.add(Connection(
