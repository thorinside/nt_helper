...
void main() {
  ...
  group('AutoRoutingService - Width-Aware Algorithms', () {
    ...
    group('VCF Stereo Connection Tests', () {
      test(
        'should assign consecutive buses for width=2 (stereo) algorithm',
        () async {
      ...
      test(
        'should avoid using occupied buses when finding consecutive buses',
        () async {
      ...
      test(
        'should handle mono to stereo connection by duplicating source',
        () async {
      ...
      test(
        'should throw InsufficientBusesException when not enough consecutive buses available',
        () async {
