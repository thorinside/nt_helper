...
void main() {
  group('Port Serialization Tests', () {
    group('Direct Properties Serialization', () {
      test('should serialize and deserialize all direct properties correctly', () {
      ...
      test('should serialize and deserialize ports with null values correctly', () {
        final originalPort = Port(
          id: 'null_values_test',
    ...
    group('Serialization Round-trip Tests', () {
      test('should maintain data integrity through multiple serialization cycles', () {
        ...
        expect(currentPort.isMultiChannel, equals(originalPort.isMultiChannel));
        expect(currentPort.channelNumber, equals(originalPort.channelNumber));
        expect(currentPort.isStereoChannel, equals(originalPort.isStereoChannel));
        ...
        expect(currentPort.parameterNumber, equals(originalPort.parameterNumber));
      });
    });
    ...
    group('Performance Tests', () {
      test('should handle large-scale serialization efficiently', () {
        ...
        final deserializedPorts = jsonList.map((json) => Port.fromJson(json)).toList();
