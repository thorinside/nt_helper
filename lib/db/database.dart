...
class AppDatabase extends _$AppDatabase {
  ...
  @override
  int get schemaVersion => 7; // Incremented schema version
  ...
  MigrationStrategy get migration => MigrationStrategy(
        ...
        onUpgrade: (Migrator m, int from, int to) async {
          ...
          if (from <= 2) {
            try {
              debugPrint("Skipping obsolete SD card tables creation (they will be dropped in version 7)...");
            } catch (e) {
          ...
          if (from <= 6) {
            try {
              debugPrint("Migrating to version 7: Removing obsolete SD card tables...");
