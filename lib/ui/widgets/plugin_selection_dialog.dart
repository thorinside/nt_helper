                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(dlgContext).textTheme.bodySmall?.copyWith(
                            color: Theme.of(dlgContext).colorScheme.onSurfaceVariant,
                          ),
                        ),
                      ],
                    ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: selectedCount > 0
                  ? () {
                      debugPrint('[PluginSelection] Install Selected button pressed: $selectedCount plugins selected');
