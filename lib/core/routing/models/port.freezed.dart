...
/// The bus number this port is connected to (1-20)
 ...
 int? get parameterNumber;// Direct properties for physical ports
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,type,direction,description,const DeepCollectionEquality().hash(constraints),isActive,outputMode,isPolyVoice,voiceNumber,isVirtualCV,isMultiChannel,channelNumber,isStereoChannel,stereoSide,isMasterMix,busValue,busParam,parameterNumber,isPhysical,hardwareIndex,jackType,nodeId]);

@override
String toString() {
  return 'Port(id: $id, name: $name, type: $type, direction: $direction, description: $description, constraints: $constraints, isActive: $isActive, outputMode: $outputMode, isPolyVoice: $isPolyVoice, voiceNumber: $voiceNumber, isVirtualCV: $isVirtualCV, isMultiChannel: $isMultiChannel, channelNumber: $channelNumber, isStereoChannel: $isStereoChannel, stereoSide: $stereoSide, isMasterMix: $isMasterMix, busValue: $busValue, busParam: $busParam, parameterNumber: $parameterNumber, isPhysical: $isPhysical, hardwareIndex: $hardwareIndex, jackType: $jackType, nodeId: $nodeId)';
}
...
@useResult
$Res call({
 String id, String name, PortType type, PortDirection direction, String? description, Map<String, dynamic>? constraints, bool isActive, OutputMode? outputMode, bool isPolyVoice, int? voiceNumber, bool isVirtualCV, bool isMultiChannel, int? channelNumber, bool isStereoChannel, String? stereoSide, bool isMasterMix, int? busValue, String? busParam, int? parameterNumber, bool isPhysical, int? hardwareIndex, String? jackType, String? nodeId
});
...
/// Create a copy of Port
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? type = null,Object? direction = null,Object? description = freezed,Object? constraints = freezed,Object? isActive = null,Object? outputMode = freezed,Object? isPolyVoice = null,Object? voiceNumber = freezed,Object? isVirtualCV = null,Object? isMultiChannel = null,Object? channelNumber = freezed,Object? isStereoChannel = null,Object? stereoSide = freezed,Object? isMasterMix = null,Object? busValue = freezed,Object? busParam = freezed,Object? parameterNumber = freezed,Object? isPhysical = null,Object? hardwareIndex = freezed,Object? jackType = freezed,Object? nodeId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  PortType type,  PortDirection direction,  String? description,  Map<String, dynamic>? constraints,  bool isActive,  OutputMode? outputMode,  bool isPolyVoice,  int? voiceNumber,  bool isVirtualCV,  bool isMultiChannel,  int? channelNumber,  bool isStereoChannel,  String? stereoSide,  bool isMasterMix,  int? busValue,  String? busParam,  int? parameterNumber,  bool isPhysical,  int? hardwareIndex,  String? jackType,  String? nodeId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Port() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.direction,_that.description,_that.constraints,_that.isActive,_that.outputMode,_that.isPolyVoice,_that.voiceNumber,_that.isVirtualCV,_that.isMultiChannel,_that.channelNumber,_that.isStereoChannel,_that.stereoSide,_that.isMasterMix,_that.busValue,_that.busParam,_that.parameterNumber,_that.isPhysical,_that.hardwareIndex,_that.jackType,_that.nodeId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  PortType type,  PortDirection direction,  String? description,  Map<String, dynamic>? constraints,  bool isActive,  OutputMode? outputMode,  bool isPolyVoice,  int? voiceNumber,  bool isVirtualCV,  bool isMultiChannel,  int? channelNumber,  bool isStereoChannel,  String? stereoSide,  bool isMasterMix,  int? busValue,  String? busParam,  int? parameterNumber,  bool isPhysical,  int? hardwareIndex,  String? jackType,  String? nodeId)  $default,) {final _that = this;
switch (_that) {
case _Port():
return $default(_that.id,_that.name,_that.type,_that.direction,_that.description,_that.constraints,_that.isActive,_that.outputMode,_that.isPolyVoice,_that.voiceNumber,_that.isVirtualCV,_that.isMultiChannel,_that.channelNumber,_that.isStereoChannel,_that.stereoSide,_that.isMasterMix,_that.busValue,_that.busParam,_that.parameterNumber,_that.isPhysical,_that.hardwareIndex,_that.jackType,_that.nodeId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  PortType type,  PortDirection direction,  String? description,  Map<String, dynamic>? constraints,  bool isActive,  OutputMode? outputMode,  bool isPolyVoice,  int? voiceNumber,  bool isVirtualCV,  bool isMultiChannel,  int? channelNumber,  bool isStereoChannel,  String? stereoSide,  bool isMasterMix,  int? busValue,  String? busParam,  int? parameterNumber,  bool isPhysical,  int? hardwareIndex,  String? jackType,  String? nodeId)?  $default,) {final _that = this;
switch (_that) {
case _Port() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.direction,_that.description,_that.constraints,_that.isActive,_that.outputMode,_that.isPolyVoice,_that.voiceNumber,_that.isVirtualCV,_that.isMultiChannel,_that.channelNumber,_that.isStereoChannel,_that.stereoSide,_that.isMasterMix,_that.busValue,_that.busParam,_that.parameterNumber,_that.isPhysical,_that.hardwareIndex,_that.jackType,_that.nodeId);case _:
  return null;
...
class _Port extends Port {
  const _Port({required this.id, required this.name, required this.type, required this.direction, this.description, final  Map<String, dynamic>? constraints, this.isActive = true, this.outputMode, this.isPolyVoice = false, this.voiceNumber, this.isVirtualCV = false, this.isMultiChannel = false, this.channelNumber, this.isStereoChannel = false, this.stereoSide, this.isMasterMix = false, this.busValue, this.busParam, this.parameterNumber, this.isPhysical = false, this.hardwareIndex, this.jackType, this.nodeId}): _constraints = constraints,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,type,direction,description,const DeepCollectionEquality().hash(_constraints),isActive,outputMode,isPolyVoice,voiceNumber,isVirtualCV,isMultiChannel,channelNumber,isStereoChannel,stereoSide,isMasterMix,busValue,busParam,parameterNumber,isPhysical,hardwareIndex,jackType,nodeId]);
