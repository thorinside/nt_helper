...
mixin _$AlgorithmSpecification {
  ...
  $AlgorithmSpecificationCopyWith<AlgorithmSpecification> get copyWith =>
      _$AlgorithmSpecificationCopyWithImpl<AlgorithmSpecification>(
          this as AlgorithmSpecification, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AlgorithmSpecification &&
...
abstract mixin class $AlgorithmSpecificationCopyWith<$Res> {
  factory $AlgorithmSpecificationCopyWith(AlgorithmSpecification value,
          $Res Function(AlgorithmSpecification) _then) =
      _$AlgorithmSpecificationCopyWithImpl;
  @useResult
  $Res call(
      {String name,
      String? unit,
...
// For older format
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AlgorithmSpecificationCopyWith<_AlgorithmSpecification> get copyWith =>
      __$AlgorithmSpecificationCopyWithImpl<_AlgorithmSpecification>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AlgorithmSpecificationToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AlgorithmSpecification &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.unit, unit) || other.unit == unit) &&
            const DeepCollectionEquality().equals(other.value, value) &&
            (identical(other.description, description) ||
...
/// @nodoc
abstract mixin class _$AlgorithmSpecificationCopyWith<$Res>
    implements $AlgorithmSpecificationCopyWith<$Res> {
  factory _$AlgorithmSpecificationCopyWith(_AlgorithmSpecification value,
          $Res Function(_AlgorithmSpecification) _then) =
      __$AlgorithmSpecificationCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
